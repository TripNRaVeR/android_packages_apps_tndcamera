...
public class CameraSettings {
    ...
    public static final String KEY_LENSSHADE = "pref_camera_lensshade_key";
    ...
    public static final String KEY_AE_BRACKET_HDR = "pref_camera_ae_bracket_key";
   ...
   public static List<String> getSupportedFlipMode(Parameters params){
    ...
    private void qcomInitPreferences(PreferenceGroup group){
        ...
        ListPreference lensShade = group.findPreference(KEY_LENSSHADE);
        ...
        if (captureMode != null) {
            filterUnsupportedOptions(group,
                     captureMode, mParameters.getSupportedCaptureModes());
        }
    ...
    private static void getFineResolutionQuality(ArrayList<String> supported,
        ...
        if (CamcorderProfile.hasProfile(cameraId, CamcorderProfile.QUALITY_WQVGA)) {
